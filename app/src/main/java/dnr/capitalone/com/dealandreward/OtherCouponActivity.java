 ...
 */
public class OtherCouponActivity extends Activity {
    GoogleMap map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_coupons);
        ...
        buttonView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(OtherCouponActivity.this, SelectedCoupon.class);
                startActivity(i);
            }
        });
        ...
        imgButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(OtherCouponActivity.this, WalletActivity.class);
                startActivity(i);
            }
        });
        ...
        imgButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(OtherCouponActivity.this, MoneyEarnedActivity.class);
                startActivity(i);
            }
        });
