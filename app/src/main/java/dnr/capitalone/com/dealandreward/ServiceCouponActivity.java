 ...
 */
public class ServiceCouponActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_coupons);
        ...
        buttonView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ServiceCouponActivity.this, SelectedCoupon.class);
                startActivity(i);
            }
        });
        ...
        imgButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ServiceCouponActivity.this, MoneyEarnedActivity.class);
                startActivity(i);
            }
        });
        ...
        imgButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ServiceCouponActivity.this, WalletActivity.class);
                startActivity(i);
            }
        });
